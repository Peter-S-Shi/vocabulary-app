...
- **Hosted release gates** — GitHub Actions runs complete `unittest discover` regression as an independent timeout-bounded release gate, then builds the Windows installer and proves a real isolated v1.0.0 → v1.1.0 overlay upgrade with data preservation.
